	...
	<div class="main">
		<section class="contact-us-banner-cont">
				...
				<div class="row justify-content-center">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-5" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
						...
						<div class="heading-desc">
							<p>
								Please feel free to say anything to us
							</p>
						</div>
					</div>
				</div>
...
<section class="policyWrap">
    <div class="container">
        <div class="privacy-text">
			<p class="policyHead" >Terms & Conditions</p>
			<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters</p>
			<p class="text-title">Information Collection</p>
			...
			<ul class="list-bullets">
				...
				<li>Dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</li>
				<li>Simply dummy text of the printing and typesetting industry.</li>
				<li>Dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</li>
				<li>Simply dummy text of the printing and typesetting industry.</li>
				<li>Dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</li>
